...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"constants\": () => (/* binding */ constants)\n/* harmony export */ });\nvar listOfDrinks = document.getElementById('busqueda');\nvar loadMoreBtn = document.getElementById('enviar');\nvar regresar = document.getElementById('mostrar');\nvar instructionsDiv = document.getElementById('instructions-id');\nvar imagenDiv = document.getElementById('imagenDiv');\nvar ingredientsDiv = document.getElementById('ingredientes-id');\nvar flexContainer = document.getElementById('infoBebidaDiv');\nvar titulo = document.querySelector(\".bar\");\nvar error = document.getElementById(\"error-id\");\nvar constants = {\n  listOfDrinks: listOfDrinks,\n  loadMoreBtn: loadMoreBtn,\n  regresar: regresar,\n  instructionsDiv: instructionsDiv,\n  imagenDiv: imagenDiv,\n  ingredientsDiv: ingredientsDiv,\n  flexContainer: flexContainer,\n  titulo: titulo,\n  error: error\n};\n\n//# sourceURL=webpack://margaritas/./src/constants.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"goToDDP\": () => (/* binding */ goToDDP)\n/* harmony export */ });\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants */ \"./src/constants.js\");\n/* harmony import */ var _infoDdp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./infoDdp */ \"./src/views/infoDdp.js\");\n\n\nvar regresar = _constants__WEBPACK_IMPORTED_MODULE_0__.constants.regresar;\nvar goToDDP = function goToDDP(drinkType, drink) {\n  //ocultar pagina principal\n  console.log(drinkType.innerText);\n  document.querySelector(\".flex-container\").style.display = \"none\";\n  document.querySelector(\".busqueda\").style.display = \"none\";\n  regresar.style.display = \"block\";\n  console.log(drink, \"---\");\n\n  //mostrar datos de bebida clickeada\n  var imgDeBebida = document.createElement(\"img\");\n  imgDeBebida.classList.add(\"class-old-image\");\n  imgDeBebida.setAttribute(\"src\", drink.strDrinkThumb);\n  if (document.getElementsByClassName(\"class-old-image\")) {\n    var oldImage = document.getElementsByClassName(\"class-old-image\");\n    for (var index = oldImage.length - 1; index >= 0; index--) {\n      oldImage[index].remove();\n    }\n  }\n  if (document.getElementsByClassName(\"parrafo-instrucciones\")) {\n    var oldParagraph = document.getElementsByClassName(\"parrafo-instrucciones\");\n    for (var _index = oldParagraph.length - 1; _index >= 0; _index--) {\n      oldParagraph[_index].remove();\n    }\n  }\n  var borrarIngredientes = document.getElementsByClassName(\"borrar-ingredientes\");\n  if (borrarIngredientes) {\n    for (var _index2 = borrarIngredientes.length - 1; _index2 >= 0; _index2--) {\n      borrarIngredientes[_index2].remove();\n    }\n  }\n  (0,_infoDdp__WEBPACK_IMPORTED_MODULE_1__.infoDdp)(drink, imgDeBebida);\n};\n\n//# sourceURL=webpack://margaritas/./src/views/goToDDP.js?");

/***/ }),

/***/ "./src/views/infoDdp.js":
/*!******************************!*\
  !*** ./src/views/infoDdp.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("module.exports = __webpack_require__.p + \"8b1cec32c8a297ca0b35.jpeg\";\n\n//# sourceURL=webpack://margaritas/./src/IMG/error_404.jpeg?");
